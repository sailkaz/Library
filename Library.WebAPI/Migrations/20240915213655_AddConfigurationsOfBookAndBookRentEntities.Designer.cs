...
namespace Library.WebAPI.Migrations
{
    ...
    [Migration("20240915213655_AddConfigurationsOfBookAndBookRentEntities")]
    partial class AddConfigurationsOfBookAndBookRentEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Library.WebAPI.Entities.BookRent", b =>
                {
                    ...
                    b.ToTable("BooksRentsMap", (string)null);
                });
            ...
            modelBuilder.Entity("Library.WebAPI.Entities.BookRent", b =>
                {
                    b.HasOne("Library.WebAPI.Entities.Book", "Book")
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Library.WebAPI.Entities.Rent", "Rent")
                        .WithMany()
